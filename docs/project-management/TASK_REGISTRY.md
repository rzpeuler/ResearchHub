...
| KNOWLEDGE-V0.3-RELATION-AWARE-OUTPUT-CONTRACT-C-011 | Derive relation-aware extractKnowledge Structured Output Contract from executable Schema 0.3 | Completed | P0 | 2026-08-31 | Luna | Current C11 implementation/governance commit (see Git handoff) | Completed / Sol Verification Pending |
| RH-LLM-DEFAULT-FLASH-001 | Change ResearchHub default DeepSeek model from Pro to Flash | Completed | P0 | 2026-09-01 | Luna | Current configuration/governance commit (see Git handoff) | Completed / Sol Verification Pending |
