...
| KNOWLEDGE-V0.3-INTEGRATION-FIX-C-005 | Fix Knowledge curation contract propagation through DSH | Completed | P0 | 2026-08-31 | Luna | Current integration-fix commit (see Git handoff) | Completed / Sol Verification Pending |
