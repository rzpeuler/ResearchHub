...
| KNOWLEDGE-V0.3-RELATION-SELECTION-GUIDANCE-C-012 | Add schema-derived endpoint-first Relation selection guidance | Completed | P0 | 2026-09-01 | Luna | Current C12 implementation/governance commit (see Git handoff) | Completed / Sol Verification Pending |
