...
| KNOWLEDGE-V0.3-POST-C12-REAL-EXTRACTION-SMOKE-C-004-S2 | Validate C12 Relation selection guidance in real Flash extraction | Completed | P0 | 2026-09-01 | Luna | Current S2 validation/evidence commit (see Git handoff) | Completed / FAIL - SOL REVIEW REQUIRED |
| KNOWLEDGE-V0.3-CANDIDATE-ISOLATED-VALIDATION-C-013 | Isolate local Entity, Relation, and Claim validation failures while preserving global safety and C9 exhaustion retry | Completed | P0 | 2026-09-01 | Luna | Current C13 implementation/governance commit (see Git handoff) | Completed / Sol Verification Pending |
