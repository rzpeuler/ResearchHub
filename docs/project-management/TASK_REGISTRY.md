...
| KNOWLEDGE-V0.3-CANDIDATE-ISOLATED-VALIDATION-C-013 | Isolate local Entity, Relation, and Claim validation failures while preserving global safety and C9 exhaustion retry | Completed | P0 | 2026-09-01 | Luna | Current C13 implementation/governance commit (see Git handoff) | Completed / Engineering Rework Required - Sol verified |
| KNOWLEDGE-V0.3-CANDIDATE-ISOLATED-VALIDATION-C-013-R1 | Restore global trusted-boundary enforcement for model-generated candidateId | Completed | P0 | 2026-09-01 | Luna | Current C13-R1 implementation/governance commit (see Git handoff) | Completed / Sol Verification Pending |
