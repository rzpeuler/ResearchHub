...
/** Deterministic market DataPlugin used by plugin and integration tests. */
export class MockMarketPlugin implements DataPlugin<MockMarketRequest, MockMarketData> {
  readonly name = 'mock-market-plugin'
...
function assertObject(value: unknown, label: string): asserts value is Record<string, unknown> {
  if (value === null || typeof value !== 'object' || Array.isArray(value)) {
    throw new PluginValidationError(`expected ${label} to be an object`)
  }
}
