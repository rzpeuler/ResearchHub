...
/** Deterministic news DataProvider used by capability and integration tests. */
export class MockNewsProvider implements DataProvider<MockNewsRequest, MockNewsData> {
  ...
  validate(value: unknown): asserts value is MockNewsData {
    if (value === null || typeof value !== 'object' || Array.isArray(value)) {
      throw new ProviderValidationError('expected news data to be an object')
    }
